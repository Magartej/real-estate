    ...
    <footer className="bg-black text-white py-10">
      <div className="container flex flex-col gap-6">
        <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 md:gap-16">
          ...
          <div className="col-span-12 sm:col-span-7 xl:col-span-5 flex flex-col gap-9">
            <p className="text-center sm:text-start">
          ...
          <div className="col-span-12 sm:col-span-8 lg:col-span-7 xl:col-span-4 flex justify-between">
